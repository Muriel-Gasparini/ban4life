import { Shield, ShieldAlert, WifiOff, LogOut, RefreshCw } from 'lucide-react';
    ...
    <header className="border-b border-zinc-800/80 bg-zinc-900/60 backdrop-blur sticky top-0 z-30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-lg font-bold tracking-tight text-white">LinkeShield</h1>
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          {/* Spam Counter */}
          <div className="hidden md:flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-zinc-800/80 text-zinc-300 border border-zinc-700/60">
            <ShieldAlert className="h-3.5 w-3.5 text-emerald-400" />
            <span>
              <strong className="text-white font-semibold">{spamCount}</strong> spams eliminados
            </span>
          </div>
